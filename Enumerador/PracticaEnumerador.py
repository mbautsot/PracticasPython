#NO ES LA MEJOR MANERA PARA HACERLO
#ENUMERATE PERMITE TENER ACCESO DE FORMA ELEGATE Y SIMPLE A OBJETOS ITERABLES
lista =['a','b','c','d','e','f']
...
#MANERA MAS ELEGANTE CON ENUMERATE
print('='*60)
lista2 =['a','b','c','d','e','f']

for indice2 , item2 in enumerate(lista2):
    # El enumerate imprimira una serie de tuples el cual contendra el (indice y valor) = (0,'a')
    print(indice2, item2)
